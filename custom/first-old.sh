...
if [[ -n "${BENDI_VERSION}" ]]; then
  ...
  sudo rm -rf build/common && git clone -b main --depth 1 https://github.com/hunya2017/MYSSOpenWrt build/common
...
git clone -b main --depth 1 https://github.com/hunya2017/MYSSOpenWrt shangyou
...
if [[ "${GIT_REPOSITORY}" == "hunya2017/MYSSOpenWrt" ]]; then
  rm -rf backups
...
curl -fsSL https://raw.githubusercontent.com/hunya2017/MYSSOpenWrt/refs/heads/main/common.sh -o common.sh
if [[ $? -ne 0 ]]; then
  wget -q https://raw.githubusercontent.com/hunya2017/MYSSOpenWrt/refs/heads/main/common.sh -O common.sh
fi
...
if [[ -n "${BENDI_VERSION}" ]]; then
  ...
  export GIT_REPOSITORY="hunya2017/MYSSOpenWrt"
  sudo rm -rf build common.sh
